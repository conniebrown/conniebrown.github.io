...
mejs.HtmlMediaElement = {
	...
	// or an array [{src:'file.MvTDKVFm',type:'video/mp4'},{src:'file.MvTDKVFm',type:'video/webm'}]
	setSrc: function (url) {
...
mejs.MediaElementDefaults = {
	...
	// enabled pseudo-streaming (seek) on .MvTDKVFm files
		...
		buildvolume: function(player, controls, layers, media) {
			...
			volumeSlider
				...
				.bind('mousedown', function (e) {
					handleVolumeMove(e);
					// force repaint
					$('.mejs-horizontal-volume-slider').css('width' , $('.mejs-horizontal-volume-slider').width()+1);
					$('.mejs-horizontal-volume-total').css('background' , $('.mejs-horizontal-volume-total').css('background'));
					$('.mejs-horizontal-volume-total').hide();
					$('.mejs-horizontal-volume-slider').css('width' , $('.mejs-horizontal-volume-slider').width()-1);
					$('.mejs-horizontal-volume-total').show();
